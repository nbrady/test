    ...
    <div className='container-fluid'>
      {mode === 'edit' && (
        ...
        {/* TODO: Create edit card container */}
          <button type='button' className='btn btn-primary' onClick={() => setMode('add')}>Add Card</button>
      ...
      {mode === 'add' && (
        <>
          <button type='button' className='btn btn-primary' onClick={() => setMode('edit')}>Edit Card</button>
